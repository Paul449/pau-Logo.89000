...
const createLogo =  function (answer){
    ...
    if(answer.shape === "circle"){
        shape = new circle(answer.shapeColor,answer.text,answer.textColor);
    } else if(answer.shape === "triangle"){
        shape = new triangle(answer.shapeColor,answer.text,answer.textColor);
    } else if(answer.shape === "square"){
        shape = new square(answer.shapeColor,answer.text,answer.textColor);
    }
    return shape.render();
}
